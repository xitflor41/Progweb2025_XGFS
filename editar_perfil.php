...
<body>
    <div class="header">
        <div class="header-buttons">
            <button class="header-btn" onclick="location.href='Articulos.php'">Volver al inicio</button>
            <button class="header-btn" onclick="location.href='logout.php'">Cerrar sesión</button>
        </div>
    ...
    <div class="container">
        ...
        <form action="actualizar_perfil.php" method="POST" class="profile-info">
            ...
            <div class="info-group">
                ...
                <input type="password" name="nueva_contrasena" placeholder="Dejar en blanco si no se cambia">
            </div>
